"""
GraphCoderRL Evaluation Pipeline
...
def evaluate_from_files(predictions_path: str, ground_truth_path: str, output_dir: str, language: str = "python") -> Dict:
    # Load predictions
    preds = {}
    ...
    results = save_results(merged, output_dir, language)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="GraphCoderRL Evaluation")
